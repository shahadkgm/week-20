...
function AdminCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://localhost:3000/api/Createstudent", {
        method: "POST",
        body: formData, 
      });
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 w-96">
         <button
    onClick={() => navigate("/admindash")}  // 👈 redirect or call onClose handler
    ...
    ✕
        ...
        <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
          ...
          <label className="flex items-center space-x-2 cursor-pointer ">
            <span className="bg-blue-500 text-white px-10 ml-15 py-2 rounded-md hover:bg-blue-600 ">
              Upload Image
            </span>
            <input
              type="file"
